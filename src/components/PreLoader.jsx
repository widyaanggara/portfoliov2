...
const Preloader = ({ onFinished }) => {
  ...
  const fullText = "www.widyaanggara.my.id";
    ...
    <AnimatePresence>
      {!fadeOut && (
        <motion.div
          ...
          className="fixed inset-0 z-50 flex flex-col items-center justify-center text-white bg-[#060010] h-screen overflow-hidden"
        >
          <DotGrid />
          ...
          {showContent && (
            ...
            >
              ...
              <motion.h1
                ...
                className="text-4xl font-moderniz font-bold mb-4"
              >
                Widya Anggara
              </motion.h1>
              <motion.div
              ...
              >
                <a href="https://github.com/widyaanggara" target="_blank" rel="noopener noreferrer" className="hover:text-[#00ffdc] transition-all duration-300 transform hover:scale-110">
                  <LuGithub size={32} />
                </a>
                <a href="https://www.linkedin.com/in/widyanggara/" target="_blank" rel="noopener noreferrer" className="hover:text-[#00ffdc] transition-all duration-300 transform hover:scale-110">
                  <FiLinkedin size={32} />
                </a>
                <a href="https://www.instagram.com/widyanggaraa/" target="_blank" rel="noopener noreferrer" className="hover:text-[#00ffdc] transition-all duration-300 transform hover:scale-110">
                  <FaInstagram size={32} />
                </a>
              </motion.div>
            </motion.div>
